...
<tr><td rowspan="3" class="bpp-logo-cell"><img src="{{ $pageThreeLogo ?? asset('images/bpp-preview/nibm-logo.png') }}" class="bpp-logo"></td><td colspan="4" class="bpp-title">BORANG</td></tr>
...
<div class="bpp-section">B(i): PERIHAL PEROLEHAN (Wajib diisi oleh Pemohon dan sila tandakan âˆš pada yang berkenaan)</div>
<table class="bpp-bi">
