<section class="print-page">
    <div class="print-page-header">
        <div>
            ...
            <h2 class="print-form-title">{{ __('C4 - Kerja') }}</h2>
            <p class="print-form-subtitle">{{ __('Lampiran Item Kerja') }}</p>
        </div>
        <div class="print-meta-stack">
            ...
            <div class="print-meta-row"><span>{{ __('Muka Surat') }}</span><strong>{{ 'C4 / 1' }}</strong></div>
        </div>
    </div>
    ...
    @if (! $isActiveAppendix)
        <div class="mt-6 print-status-banner">
            <em>{{ __('Nota:') }}</em>
            {{ __('Lampiran ini bukan lampiran aktif untuk kategori perolehan semasa, namun pratonton ini masih memaparkan data C4 yang disimpan pada draft.') }}
        </div>
    @endif

    <div class="print-section">
        <p class="print-section-title">{{ __('Butiran Item C4 - Kerja') }}</p>
    ...
    <div class="mt-6 print-totals-grid">
        <div class="print-total-box">
            <span>{{ __('Jumlah Baris C4') }}</span>
            <strong>{{ $appendixRows->count() }}</strong>
        </div>
        <div class="print-total-box">
            <span>{{ __('Jumlah Besar C4 (RM)') }}</span>
